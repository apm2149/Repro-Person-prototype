  ...
  return (
    <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
            <LogoIcon className="h-12 w-12 text-blue-600 mx-auto" />
        ...
        <form className="mt-8 space-y-6 bg-white p-8 rounded-xl shadow-lg border" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              <label htmlFor="username-admin" className="sr-only">ID</label>
              <input
                id="username-admin"
                name="username"
                type="text"
            ...
            <div>
              <label htmlFor="password-admin" className="sr-only">パスワード</label>
              <input
                id="password-admin"
                name="password"
                type="password"
